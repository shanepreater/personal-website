                ...
                <Row>
                    <Col sm={6} md={7}>
                        ...
                        <ul className="list-unstyled footer-link d-flex">
                            ...
                            <li><a href="https://twitter.com/PreaterShane" className="p-2"><FontAwesomeIcon
                                icon={["fab", "twitter"]}/></a></li>
                            <li><a href="https://www.linkedin.com/in/shanepreater/" className="p-2"><FontAwesomeIcon
                                icon={['fab', 'linkedin']}/></a></li>
                        </ul>
                    ...
                    <Col sm={6} md={4} lg={2}>
                        ...
                        <ul className="list-unstyled footer-link">
                            <li><Button variant="link" className="nav-link" onClick={() => setShowDisclaimer(true)}>Terms
                                of use</Button></li>
                            <li><Button variant="link" className="nav-link"
                                        onClick={() => setShowDisclaimer(true)}>Disclaimers</Button></li>
                            <li><Button variant="link" className="nav-link" onClick={props.showContact}>Contact</Button>
                            </li>
                        </ul>
                    </Col>

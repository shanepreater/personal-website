                    ...
                    <Tab eventKey="content" title="Site Content">
                        <div className="disclaimer">
                            ...
                            <p>The information contained in this website is for general information purposes only. The
                                information is provided by the owner (Shane Preater) and while we endeavour to keep the
                                information up
                            ...
                            <h4>Blog posts</h4>
                            <p>This is a personal blog. Any views or opinions represented in this blog are personal and
                                belong solely to the blog owner (Shane Preater)
                                and do not represent those of people, institutions or organizations that the owner may
                                or
                                may not be associated with in professional or personal capacity, unless explicitly
                                stated.
                                Any views or opinions are not intended to malign any religion, ethnic group, club,
                                organization, company, or individual.
                            </p><p>
                            All content provided on this blog is for informational purposes only. Although best efforts
                            are
                            made to ensure accuracy at the time of publishing, the owner of this blog makes no
                            representations as to the accuracy or completeness of any information on this site or found
                            by
                            following any link on this site. The owner will not be liable for any errors or omissions in
                            this information nor for the availability of this information. The owner will not be liable
                            for
                            any losses, injuries, or damages from the display or use of this information.</p>
                        </div>
                    </Tab>
                    <Tab eventKey="general" title="General">
                        <div className="disclaimer">
                            ...
                            <p>
                                ...
                                control of
                                the owner. We have no control over the nature, content and availability of those sites.
